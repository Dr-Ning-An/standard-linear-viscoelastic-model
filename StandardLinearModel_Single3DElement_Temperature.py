...
## Temperature effects are predicted by the Williams-Landel-Ferry equation.
#######################################################################################
# -*- coding: mbcs -*-
from part import *
...
C1 = 1
C2 = 10
T0 = 20 # degree Celsius; reference temperature

T = 18 # Temperature of Interest
...
mdb.models['Model-1'].materials['Material-1'].viscoelastic.Trs(table=((T0, C1, C2), ))
...
mdb.models['Model-1'].Temperature(createStepName='Initial', 
    ...
    UNIFORM, magnitudes=(T, ), name='Predefined Field-1', region=
...
jobName = 'StandardLinearModel_Single3DElement_Temperature'
